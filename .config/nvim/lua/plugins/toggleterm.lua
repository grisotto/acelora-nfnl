...
local function _1_()
  ...
  return toggleterm.setup({open_mapping = "<a-i>", direction = "vertical", size = 80, shade_terminals = true, start_in_insert = true, insert_mappings = false, terminal_mappings = false})
end
local function _2_()
